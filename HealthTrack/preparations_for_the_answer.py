...
class HealthAdvisorAI:
    def __init__(self, user_data):
        ...
        self.headers = {"Authorization": "Bearer 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"}
    ...
    def _generate_prompt(self):
        ...
        Ответ оформляй маркированным списком на русском языке и латыни для указания болезни.  [/INST]
        """
