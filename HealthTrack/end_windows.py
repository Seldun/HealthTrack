...
"color: rgb(0, 42, 5);")
        ...
        self.label_3.setGeometry(QtCore.QRect(100, 40, 395, 61))
        font = QtGui.QFont()
    ...
    def load_answer_text(self):
        # Путь к файлу answer.txt
        base_dir = os.path.dirname(os.path.abspath(__file__))
        answer_file_path = os.path.join(base_dir, "answer.txt")

        with open(answer_file_path, "r+", encoding="utf-8") as file:
            answer_text = file.read()
            self.place_for_answer.setText(answer_text)
